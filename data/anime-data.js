    ...
    '2026': {
        ...
        'B': [
            ...
            },
            {
                ...
                review: "По началу ание показалось очень крутым, но после 5+ серий с этой героиней, которая ведёт себя максимально раздражающе, мне с каждой серией стало смотреть всё тяжелее и тяжелее. От этого аниме небольшие вайбы Биско-ржавоеда."
            },
            {
                title: "Jujutsu Kaisen: Shimetsu Kaiyuu - Zenpen",
                ruTitle: "Магическая битва 3",
                review: "Этот сезон стал чутка скучнее, чем предыдущие, мб из-за того, что я почти весь сюжет знал. Но я не знал о... павер-апе... перевоплощении Маки Зенин. Мне нравился Тоджи как персонаж, который был мегасильным и давал лещей магам, но мне не нравится его картинка мира... я хз как это описать. А вот Маки такая же как и Тоджи, но она типо добрая и не хейтит магов, вроде. Мб, любимый персонаж после Сугуры Гето."
            },
            {
                title: "Jigokuraku 2",

    ...
    '2026': {
        'S': [
            ...
            },
            {
                ...
                review: "До выхода сезона уже были скандалы, что некоторые моменты повырезали, и это правда. Сезон по самой лучшей арке - 6-ой (я пока что не учитываю 9ую и 10ую арки, т.к. не читал, но спойлеры я словил плотные, так что могу сказать, то контент там будет сочный... когда-то) урезали донельзя. Студия попыталась впихнуть невпихуемое. 90 глав из вебки (я хз сколько в ранобэ) в 19 серий. Давайте быстро пробегусь по тому что урезали: цветочное поле, новое полномочие Субару, тоннель с миазмами, бой с Кентавром (урезали 90%). Но как для зрителя думаю норм. С такой рисовкой, с такой кровякой грех жаловаться, наверное..."
            },
        ],
        'A': [
            {
        ...
        'C': [
            ...
            },
            {
                ...
                review: "Первая серия этого аниме сильно была расфоршена в тт, и... заслужено... Анимешка прикольная, простая, красивая и милая."
            },
            {
                title: "Tensura 4",
            ...
            },
            {
                ...
                ruTitle: "Троецарствие Японии",
                review: "Необычная рисовка, ну а бекграунд истории очень даже интересный и типо приближён к реальности, но неполностью."
            },
            {
            ...
            },
            {
                ...
                review: "Неплохое аниме, смотрится бодро, но в целом дефолтнй тайтл."
            },
            {
                title: "Golden Kamuy",
        ...
        'D': [
            ...
            },
            {
                ...
                review: "Дефолт этти аниме, ничего интересного."
            },
            {

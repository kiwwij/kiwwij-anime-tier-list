    ...
    '2026': {
        'S': [
            ...
            },
            {
                ...
                review: "До выхода сезона уже были скандалы, что некоторые моменты повырезали, но всё всё таки нет. Сезон по самой лучшей арке - 6-ой (я пока что не учитываю 9ую и 10ую арки, т.к. не читал, но спойлеры я словил плотные, так что могу сказать, то контент там будет сочный... когда-то). А рисовка какая бомбовая, теперь 1-ым сезонам должны сделать ремейк!"
            },
        ],
        'A': [
            {
                title: "One Piece",
                ruTitle: "Ван Пис",
                review: "Честно, не так уже интересно смотреть историю, т.к. слишком всё по детски + студия не может просто по сюжету идти, так что я жду ремейк и с диким кайфом буду пересматривать."
            },
            {
                title: "Vinland Saga",
                ruTitle: "Сага о Винланде",

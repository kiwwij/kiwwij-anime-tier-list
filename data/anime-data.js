    ...
    '2026': {
        'S': [
            ...
            },
            {
                ...
                review: "До выхода сезона уже были скандалы, что некоторые моменты повырезали, и это правда. Сезон по самой лучшей арке - 6-ой (я пока что не учитываю 9ую и 10ую арки, т.к. не читал, но спойлеры я словил плотные, так что могу сказать, то контент там будет сочный... когда-то) урезали донельзя. Студия попыталась впихнуть невпихуемое. 90 глав из вебки (я хз сколько в ранобэ) в 19 серий. Давайте быстро пробегусь по тому что урезали: цветочное поле, новое полномочие Субару, тоннель с миазмами, бой с Кентавром (урезали 90%). Прозвище Рейда Ван Астрея перевели как Махальщик, хотя он Палочник, т.к. сражался палочками для еды. Показали Сесилуса и Халибела, думаю, что 5-ый сезон не заставит ждать. Вырезали момент, где субару, после своей 1ой смерти (после потери памяти) - рассказывал всем что он человек из другого мира, а его спутники не понимали значения этих слов, и считали что он из великого водопада. Субару стоя возле лестницы услышал как они говорили про этот момент, склоняя его к тому что он шизоид, и 1ая кто об этом говорил являлась Анастасия (Ехидна), она выказала что сейчас надеяться на Субару невозможно. Также показали Вэйга Адгарда, типа который появлялся в ифке Сасагеру."
            },
            {
        ...
        'B': [
            ...
            },
            {
                ...
                review: "Первое что бросается в глаза - отношение Леди к Данте. Меня это прям умиляет. Разачаровн, что опенинг и эндинг не такие крутые и смешные как в 1-ом сезоне. Благодаря аниме меня заинтересовала вселенная DMC, поэтому я посмотрю виодосы про сюжет игр и, возможно, поиграю, но в этом я не уверен. Я тут узнал, что аниме неканон, так что теперь уверен, что играть не буду."
            },
            {

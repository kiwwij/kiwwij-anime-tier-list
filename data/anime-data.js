    ...
    '2026': {
        'S': [
            ...
            },
            {
                ...
                review: "До выхода сезона уже были скандалы, что какие-то моменты повырезали. И если судить по ранобэ, то пару сцен эмоцианальных вырезали, что, конечно, плохо, но не критично, т.к. комьюнити сделает всё за студию. Сезон по самой лучшей арке - 6ой (я покачто не учитываю 9ую и 10ую арки, т.к. не читал, но спойлеры я словил плотные, так что могу сказать, то контент там будет сочный... когда-то). А рисовка какая бомбовая, теперь 1ым сезонам должны сделать ремейк!"
            },
        ],
        'A': [
            {
                title: "One Piece",
                ruTitle: "Ван Пис",
                review: "24 серии в год это мало. Буду ждать ремейка и с диким кайфом пересматривать."
            },
            {
                title: "Vinland Saga",
                ruTitle: "Сага о Винланде",
        ...
        'B': [
            ...
            },
            {
                ...
                review: "Пока что очень интересный сезон. Рисовка хорошоя, но её почему-то хейтят. Мб, если сравнить прошлые сезоны, но мне почему-то нравится. Сюжет держит в напряжении всё время. Возможно лучший сезон. И у меня уже давно невероятное желание прочитать новеллу."
            },
            {
                title: "Tongari Boushi no Atelier",
                ruTitle: "Ателье колдовских колпаков",
                review: "Красивое аниме, но пока что скучное. Буду смотреть дальше."
            },
            {
        ...
        'C': [
            ...
            {
                title: "Shunkashuutou Daikousha, Haru no Mai 2026",
                ruTitle: "Агенты четырёх сезонов: Весенний танец",
                review: "Первая серия этого аниме сильно была расфоршена в тт, и заслужено. Анимешка прикольная, простая, красивая."
            },
            {
            ...
            },
            {
                ...
                review: "Рисовка хорошая, местами даже прям супер."
            },
            {
                title: "Himekishi wa Barbaroi no Yome",
                ruTitle: "Принцесса-рыцарь — невеста варвара",
                review: "1ая серия - битва белого мечника против чёрного с дувручным мечём... а потом один другого поработил... чё я смотрю вообще? Короче, дефолтный гаремник. Но рисовка хорошая. Думаю, что через лет 5-10 у каждого шлака будет хорошая рисовка. Следует мне поменьше восхищаться этим. А вот раньше!.."
            },
        ],
        'D': [
            {
            ...
            },
            {
                ...
                ruTitle: "Похоже, сильнейшая профессия — это не герой или мудрец, а (временный) инспектор?",
                review: ""
            },
            {
                title: "Gals Can't Be Kind to Otaku!?",
                ruTitle: "Где те девушки, что были бы добры к отаку?",
                review: "Кринж. Смотреть можно, но с трудом, думаю что дропну."
            },
            {
                title: "Liar Game",
                ruTitle: "Игра лжецов",
                review: "Ещё одно аниме про попытку обануть одного человека другим человеком. Максимально дефолтное и бональное."
            },
        ],
        'E': [
            {
        ...
        'F': [
            ...
            },
            {
                title: "Natsu e no Tunnel, Sayonara no Deguchi",
                ruTitle: "Тоннель в лето, выход прощаний",
                review: "Посмотрел чисто ради того, чтобы сделать сравнение с ранобэ - (ссылка)"
            },
            {

...
const tierListData = {
    ...
    '2022': {
        ...
        'C': [
            ...
            {
                title: "Mobseka",
                ruTitle: "Мир отомэ-игр — это тяжёлый мир для мобов",
                review: ""
            },
        ],
        'D': [
    ...
    '2026': {
        'S': [
            ...
            },
            {
                ...
                review: "До выхода сезона уже были скандалы, что некоторые моменты повырезали, и это правда. Сезон по самой лучшей арке - 6-ой (я пока что не учитываю 9ую и 10ую арки, т.к. не читал, но спойлеры я словил плотные, так что могу сказать, то контент там будет сочный... когда-то) урезали донельзя. Студия попыталась впихнуть невпихуемое. 90 глав из вебки (я хз сколько в ранобэ) в 19 серий. Давайте быстро пробегусь по тому что урезали: цветочное поле, новое полномочие Субару, тоннель с миазмами, бой с Кентавром (урезали 90%). Прозвище Рейда Ван Астрея перевели как Махальщик, хотя он Палочник, т.к. сражался палочками для еды. Показали Сесилуса и Халибела, думаю, что 5-ый сезон не заставит ждать. Вырезали момент, где субару, после своей 1ой смерти (после потери памяти) - рассказывал всем что он человек из другого мира, а его спутники не понимали значения этих слов, и считали что он из великого водопада. Субару стоя возле лестницы услышал как они говорили про этот момент, склоняя его к тому что он шизоид, и 1ая кто об этом говорил являлась Анастасия (Ехидна), она выказала что сейчас надеяться на Субару невозможно. Также показали Вэйга Адгарда, типа который появлялся в ифке Сасагеру. 11 серия 4-го сезона, точнее её конец, точнее песня, коотрая была в конце, это отсылка на 11 серию 1-го сезона. Песня 'Stay Alive!' просто идеально вписывается."
            },
            {
            ...
            },
            {
                ...
                review: "Смешанные чувства у меня от этого фильма. 1-ая половина филлерная, да она закрывает некоторых персонажей из 1-го сезона, но не уделять же этому целый час, так ещё в флешбеков много. 2-ая половина, я бы сказал, фансервисная. Потому что мы думали, что Майор мёртв, а тут он жив и не стал встречатся с Вайолет. Как по мне глупая причина, да он хотел подарить ей хорошее детство, но по итогу она потеряла руки на войне. Но он даже не попытался исправь, как он думает, свои ошибки. Но по итогу они всё таки встретились и остались жить вместе на острове. Всё равно я рад, что эта история закончилась именно так. Фильм потрясающий, красивый и всё также пробивает меня на слёзы, самое сильное произведене, с точки зрения эмоционального... напряжения? Я хз как правильно это описать. Я держался, я не пустил слезу! Хотя очень хотел. Наверное немного кринжово такое говорить, но если у меня когда-нибудь будет дочь, то я её назову Виолетта."
            },
            {
                title: "Made in Abyss",
                ruTitle: "Созданный в бездне",
                review: "Когда-то давно я уже начинал смотреть это аниме, но дропнул, уже не помню почему. Но в этот раз я посмотрел 1ый сезон и он мне понравился. Рисовка красивая, сюжет интересный, как и персонажи. Думаю многие знают, что там детям делают бо-бо, ну короче да. Честно, мало что можно сказать. Просто интересное произведение. (я готов был поставить этому аниме 10 баллов, но опять же, чего-то не хватает, хотя всё в целом очень даже хоршо)"
            },
            {
                title: "Made in Abyss: Dawn of the Deep Soul",
                ruTitle: "Созданный в Бездне: Рассвет глубокой души",
                review: "Отличный фильм, который продолжает историю 1-го сезона. Рисовка на высоте, сюжет интересный, персонажи раскрываются ещё больше. Фильм тяжёлый, особенно для чувствительных людей. Я был очень тронут историей Митти и Прушки."
            },
            {
                title: "Made in Abyss Season 2",
                ruTitle: "Созданный в Бездне 2",
                review: "2-ой сезон невероятно интересный. Сюэет захватывающий. У меня столько вопросов! Я испытал невероятные эмоции от этого аниме. Теперь оно стало одним из моиъ любимых. Я не могу дождаться продолжения истории."
            },
            {
                ...
                review: "Старый, добрый безработный. В этом сезоне намного меньше вырезни и плохой отсебятины, хоть она и есть. Рисовка хорошоая, арка одна из самых интересных короче супер. Жалко что дубляж говно полное, но это россия, тут ничего не поделать."
            },
            {
                title: "Summer Time Rendering",
                ruTitle: "Летнее время",
                review: "Помню в 2022-ом году смотрел это аниме в онгоинге, но по какой-то причине дропнул и спустя 4 года решмл досмотреть. Что могу сказать? В этом аниме упомянули ремейук фф7 в 18 серии, было ли это в оригинале, но озвучке от анилибрии да. Так вот, аниме просто шикарное, я был глупцом, что дропнул его 4 года назад. Сюжет держит в напряжении на протяжении всего аниме. Лучше 1 раз посмотреть, чем слушать отзыв от других людей."
            },
        ],
        'A': [
            {
            ...
            },
            {
                ...
                ruTitle: "Дьявол может плакать 2",
                review: "Первое что бросается в глаза - отношение Леди к Данте. Меня это прям умиляет. Разачаровн, что опенинг и эндинг не такие крутые и смешные как в 1-ом сезоне. Появились крутые песни, которые добавил себе в плейлист. Благодаря аниме меня заинтересовала вселенная DMC, поэтому я посмотрел виодосы про сюжет игр. Кстати, я тут узнал, что аниме неканон."
            },
            {
                title: "The Legend of Vox Machina Season 4",
                ruTitle: "Легенда о Вокс Макине 4",
                review: "Хороший сезон, посмотрел залпом. Я так понимаю, что следующий сезон последний, который вроде как выйдет в 2027 году. Жду с нетерпением."
            },
            {
                title: "Daemons of the Shadow Realm",
                ruTitle: "Цугаи загробного мира",
                review: "Очень интересное аниме от автора алхимика, что прослеживается в персонажах. Интересный сюжет, хорошая рисовка. В аниме всего лишь 24 серии, думаю мангу пойду читать."
            },
            {
                title: "The Mighty Nein",
                ruTitle: "Могучая девятка",
                review: "Очень интересное произведение. Как я понял от создателей Вокс Макина. Жаль что пока 1 сезон. Буду ждать продолжение. Можетон скоро выйдет."
            },
            {
                title: "Clannad ~After Story~",
                ruTitle: "Кланнад 2",
                review: "Скажу сразу, что это аниме было сделано по игре, а в игре несколько концовок, что и обыграли в аниме. Такое мне не особо нравится, но ничего не поделаешь. Жалко что я узнал про это произведение только сейчас, и не играл в оригинал. Увы, но я не усидчивый в плане новелл, особенно таких старых. Как же жалко!(((((( Теперь про аниме. Я понял почему это аниме считается одним из драматичных. После 1-го сезона, в котором была забавная школьная жизнь с элементами драмы, 2-ой сезон поражает своей суровой атмосферой и реальностью (после 17 серии особенно, но 1-ая половина всё про те же школьные дни). Мне было тяжело смотреть, от одного только упоминания Нагисы, даже от одних слов дочки  гг, слёзы так и наворачивались. Так сюжет ещё сильнее завернули в 20-21 сериях. Таким и пытать можно. Но потом как я и говорил произашёл откат, типо другой концовки в игре. В игре надо было собрать 13 огней, посмотреть концовку с Нагисой и Усио и только потом можно получить счастливую концовку где все... а знате, я говорить не буду, хотя думаю ы и сами всё поняли. По уровню драммв наравне с Вайолет Эвергарден."
            },
        ],
        'B': [
            {
                title: "One Piece",
                ruTitle: "Ван Пис",
                review: "Не многие поймут почему Ван Пис в этом тире. Он тут оказался из-за того, что стал максимально детским, и я бы даже сказал немного пративны, лично для меня. Смотрю уже не с таким кайфом как в 2022 году, но это не касается сражений. Жду ремейк и с диким кайфом буду пересматривать."
            },
            {
            ...
            },
            {
                ...
                review: "Неплохой сезон, из-за которого у меня снлва плявидлсь желание прочитать новеллу. Рисовка 1-ых 3-ёх серий была хорошей, но с каждой серией всё хуже и хуже. Будуждать новый сезон или пойду читать новеллу."
            },
            {
                title: "Tensura 4",
            ...
            },
            {
                ...
                review: "Интересное продолжение, я про то что идёт с 6-ой серии, то что до... не буду об этом. Понравилось, что отношения гг и Ребекки развиваются. Нравится, что в этом аниме много разных национальностей и прикольные имена/клички персонажей. Жалко, что продолжения нет. Думаю, пойду мангу читать, хоть и она до конца не вышла."
            },
            {
                title: "Super no Ura de Yani Suu Futari",
                ruTitle: "История о перекуре за супермаркетом",
                review: "В целом неплохое, милое аниме, но местами кринжовое."
            },
            {
                title: "Suzumiya Haruhi no Yuuutsu",
                ruTitle: "Меланхолия Харухи Судзумии",
                review: "1-ые 3 серии я думал, что это просто прикольная и малиая анимешка, в которой приятная рисовка и офигенный дубляж, но после 4-ой серии... началась фантистика."
            },
            {
                title: "Suzumiya Haruhi no Shoushitsu",
                ruTitle: "Исчезновение Харухи Судзумии",
                review: "Хороший фильм, но долгий и местами кринжовый. Очень понравилась другая версия мира, особенно новая версия Юки Нагато, теперь это топ 1 вайфу произведения. К Харуки я отношусь больше негативно, из-за её эгоимза, особенно после коцна 1-го сезона, где снимали фильм. Следующая часть 'Исчезновение Юки Нагато'. Отзывы не самые крутые, но как я понял этот сезон про попытку Юки признаться Кёну, гг, в чувствах, и 1 комментатор написал, что это за 16 серий не произойдёт. Так там ещё и рисовка отвратительная. Поэтому и смотреть не буду. В целом я рал, что познакомился с этим произведением, оно интересное и необычное. Но это всё благодаря озвучку от reanimedia, если бы не она, то я бы не досмотрел."
            },
            {
                title: "BECK",
                ruTitle: "Бек",
                review: "Интересное аниме, что-то типо'The Whiplash', только командная. Взбесили меня только сестра Рюсукэ и ещё пару женщин. Жалко что нет продолжения."
            },
            {
                title: "Clannad: Another World, Tomoyo Chapter",
                ruTitle: "Кланнад: Другой мир, глава Томоё",
                review: "Как альтернативная история неплохо. Минус в том, что проблема высосана из пальца. Типо у главы студ совета нет времени на парня-гг. А гг потом её отшивает и говорит, что обуза для неё. Хотелось бы увидеть побольше. Рисовка очень хорошая. Последняя серия 1-го сезона это есть эта ОВА."
            },
            {
                title: "Clannad: After Story - Another World, Kyou Chapter",
                ruTitle: "Кланнад: Продолжение истории — Другой мир, глава Кё",
                review: "Это альтернативная история куда интереснее и тяжелее смотреть, т.к. там любовный ьреуголбник между гг и близнецами. Но тут такая же проблема - нехватка времени. 1 серия для расскрытия ситуации недостаточно. Это часть есть в последней серии 2-го сезона. Интересно а в игре история прям до конца расписана или так же как и в аниме?"
            },
            {
                title: "Bakemonogatari",
                ruTitle: "Истории монстров",
                review: "Интересное, но большое произведение. Поэтому его надо смотреть в правильном  порядке https://ru.yummyani.me/catalog/collection/107 Я пока только начал, но мне нравится. Не скажу что этот сезон какой-то мега крутой, но он интересный, так что продолжу смотреть. Может в дальнейшем я поменяю тир, но пока так. Ах да, тут ещё и оппенинги крутые."
            },
            {
                title: "Kizumonogatari Part 1: Iron-Blooded",
                ruTitle: "Истории ран: Железная кровь",
                review: "Рисовка стала лучше, оно и не удивительно. Короче норм, смотрим дальше."
            },
            {
                title: "Kizumonogatari Part 2",
                ruTitle: "Истории ран 2: Горячая кровь",
                review: "Всё так же хорошо."
            },
            {
                title: "Kizumonogatari Part 3",
                ruTitle: "Истории ран 3: Холодная кровь",
                review: "Всё так же хорошо. Но фиг пойми почему всё так."
            },
            {
                title: "Shuumatsu no Valkyrie",
                ruTitle: "Повесть о конце света",
                review: "На удивление не плохо. Смотрится на одном дыхании. 3 файта по 4 серии."
            },
            {
                title: "Record of Ragnarok 2nd Season",
                ruTitle: "Повесть о конце света 2",
                review: "Держит планку."
            },
            {
                title: "Record of Ragnarok III",
                ruTitle: "Повесть о конце света 3",
                review: "Держит планку."
            },
            {
                title: "Fate/stay night: Heaven's Feel - I. Presage Flower",
                ruTitle: "Судьба/Ночь схватки: Прикосновение небес",
                review: "Было ошибкой смотреть этот фильм спустя пару лет после просмотра предыдущих сезонов. Я почти ничего не помню, поэтому мне было тяжело понять что происходит. Но в целом фильм неплохой. Динамичный, красивый, короче норм."
            },
            {
                title: "Gekijouban Fate/Stay Night: Heaven's Feel - II. Lost Butterfly",
                ruTitle: "Судьба/Ночь схватки: Прикосновение небес 2",
                review: "Очень интересный фильм, т.к. наконец-то нет повторов и флешбеков всех предыдущих частей. Очень инересно чем всё закончится, и до сих пор многое что не понятно. По хорошему посмотренть разбор на ютубе, но это когда-то в будующем."
            },
            {
                title: "Fate/stay night: Heaven's Feel - III. Spring Song",
                ruTitle: "Судьба/Ночь схватки: Прикосновение небес 3",
                review: "Как я поманию, это последний сюжетный фильм в этой вселенной, дальше только доп контент. Что могу сказать? Фильм хороший, концовка почему-то урезана и немного изменена, но в целом нормльно. Дальше идёт девочка-волшеюница и ещё пару, точнее много фильмов и сезонов (всего 62 разных сезона/фильма/спэшла, в это вселенной очень интересно разобраться, но времени просто нет), понемногу буду смотреть, что-то скипать."
            },
            {
                title: "Fate/Grand Order: Absolute Demonic Front - Babylonia",
                ruTitle: "Судьба/Великий приказ: Вавилония",
                review: "Эта вселенная, возможно, даже лучше оригинального фейта. Хороший сююжет, всё также отличная рисовка, боёвка, персонажи. Не могу представить что меня может ждать дальше, но я уверен, что впереди меня ждут неменее интересные фильмы."
            },
            {
                title: "Fate/Grand Order: Shinsei Entaku Ryouiki Camelot 1 - Wandering; Agateram",
                ruTitle: "Судьба/Великий приказ: Камелот — Странствие",
                review: "Это часть сделана по тойже формуле, что и предыдущая. Есть несколько сил и мировое зло, которое чего-то хочет добится. Этим злом выступает Король Артур (Арутурия Пендрагон или же Сэйбер), по крайнер мере пока что. В целом фильм неплохой, но я бы сказал, что он не дотягивает до уровня предыдущего сезона. В отрыве от всех частей нелохо. Ещё вкину 1 факт, который меня интересовал долгое время. И вот я досматриваю вселенную фейта и могу сказать, что Красная Сэйюер - Мордред - это гомункул-клон и «сын» Артурии (созданный её сестрой, Морганой, из ДНК короля). Понимаю что очень запутано, но всё же. Интересно познавть этих персонажей, кто кому родня, а кто просто ещё одно воплощения класса (тут я имею в виду классы в войне за грааль). Надо бы ещё понять как все эти части связаны между собой, но тут уже ютуб в помощь."
            },
            {
                title: "Fate/Grand Order: Divine Realm of the Round Table - Camelot Paladin; Agateram",
                ruTitle: "Судьба/Великая Кампания: Камелот - Паладин",
                review: "Ну держит планку, большая часть фильма просто файты, это круто. А ещё я понял, что тот порядок, который нашёл в инетере был не самым лучшим, т.к. я до сих пор не понимаю главную цель этой вселенной фильмов и тв."
            },
            // {
            //     title: "Fate/strange Fake",
            //     ruTitle: "Судьба/Странная подделка",
            //     review: "Рисовка как у 'Шёпота рассвета'. Не помню говорил ли я раньше, но почти все фильмы и сезоны одинаковые, только персонажи местами другие и события, но основа одна и та же. Всё идёт по одному сценарию. Ещё у этой подделки будет продолжение, но не уверен, что я буду смотреть."
            // },
        ],
        'C': [
            {
            ...
            },
            {
                title: "Look Back",
                ruTitle: "Оглянись",
                review: "Прикольная добрая анимешка, но вот смысл её до конца я не понял. Это произведение от создателя бензопилы, но я не понял что автор хотел донести этим аниме. Может какие-то личные переживания, может что-то другое. Если бы язнал бэкграунд, возможно, этот фильм бывл выше в рейтинге. Самое забавное это то, что у меня на обоях ноута было именно это аниме, которое находится в любымых мастерской стима. Можно ли сказать фраху 'Как тесен мир.'?"
            },
            {
                title: "Suzumiya Haruhi no Yûutsu",
                ruTitle: "Меланхолия Харухи Судзумии 2",
                review: "Сезон хороший, но как же он меня выбесил. Если учитывать 1-ый, то больше 6 (почтиполовина 2-го сезона) серий было уделено повторениям (возврату во времени). Я серии просто скипал. Я понимаю, что хотели показать безумие или что-то типо того, но можно было не в стольких сериях. А розгадка было в домашнем задании, что можно было понять спустя 2-3 серии. Вся эта ситуация меня взбесила, уйма просранног времени. Также меня начала бесить Харуки, как только она открывала свой эгоистичный рот, я хотел закрыть его, я могу сравнить её с Генсухой. На месте гг я бы просто ливнул из клуба, и пускай мир сам бы разбирался."
            },
            {
                title: "I'm standing on 1,000,000 lives.",
                ruTitle: "Я стою на миллионах трупов",
                review: "Помню смотрел в 21-ом году, но не помню досмотрел или дропнул. В этот раз досмотрел, прикольное аниме."
            },
            {
                title: "100-man no Inochi no Ue ni Ore wa Tatteiru 2nd Season",
                ruTitle: "Я стою на миллионах трупов 2",
                review: ""
            },
            {
                title: "Hitsugi no Chaika",
                ruTitle: "Чайка - принцесса с гробом",
                review: "Неплохое аниме, рисовка чутка хромает, но в целом неплохо."
            },
            {
                title: "High School of the Dead",
                ruTitle: "Школа мертвецов",
                review: "Когда-то давно я смотрел это аниме, но по какой-то причине дропнул. В этот раз досмотрел, и оно неплохое. Клешированное с фансервисом, но в целом прикольно."
            },
            {
                title: "The Exiled Heavy Knight Knows How to Game the System",
                ruTitle: "Изгнанный реинкарнированный тяжёлый рыцарь не имеет себе равных в знаниях игры",
                review: "Рисовка плохоая, сюжет бональный, но аниме смотрибельное."
            },
            {
                title: "Dara-san of Reiwa",
                ruTitle: "Дара из Рэйвы",
                review: "Забавное аниме про духа горы и детей. Больше ничего."
            },
            {
                title: "Love Unseen Beneath the Clear Night Sky",
                ruTitle: "Я влюбился в тебя, когда ты бежала в лунной ночи",
                review: "Неплохая романтика, где девушка слепая и больна раком. Я себе проспойлерил весь сюжет и могу сказать, что грустная история, но кринжовая, если судить по аниме."
            },
            {
                title: "Dorohedoro 2",
                ruTitle: "Дорохедоро 2",
                review: "Стало очень интересно, но всё равно ничего не понятно. Но из-за того, что 1-ый сезон я не понял, то выше не могу и не хочу ставить, но вот может 3-ий сезон)"
            },
            {
                title: "CLANNAD",
                ruTitle: "Кланнад",
                review: "Хорошое и милое аниме. Первые 10 серий пролетели быстро. Потом серий 5-6 было скучно, а потом снова интересно. Драмы как таковой тут мало. Раньше мне нравилось, что в гг влюблялось много девушек, но со временем понял, что тяжело сопереживать всем и неприятно видеть как одна девушка проигрывает в этой... гонке, хз как называть. Думаю, началось это с аниме 'Пять невест'. И поэтому студия или автор решили сделать фильмы, в которых главный герой выбирает других девушек. Эти ифки показывают концепцию «А что, если бы...». Ну а Фильм Кланнад 2007 года попытался впихнуть всю историю 1-го и 2-го сезона. Я попроьую его посмотреть, но скорее всего скипну. Пока не понимаю почему это аниме считается одним из самых грустных, пошёл искать инфу (спойлерить)."
            },
            {
                title: "Tensei shitara Slime Datta Ken Movie: Soukai no Namida-hen",
                ruTitle: "О моём перерождении в слизь: Слёзы синего моря",
                review: "Как доп контент для фанатов слизи, то норм. Но на большее не тянет."
            },
            {
                title: "Mahoutsukai no Yome: Hoshi Matsu Hito",
                ruTitle: "Невеста чародея: В ожидании путеводной звезды",
                review: "Ну норм, но как я понял это набыло смотреть после 12-ой серии 1-го сезона."
            },
            {
                title: "Chained Soldier",
                ruTitle: "Раб спецотряда демонического города",
                review: "В этом аниме явно есть на что посмотреть, ну если вы понмиаете о чём я БОМ-БОМ))) Но если серьёзно, то кринж, только рисовка хорошая. А ещё я уже дропал это аниме, но решил посмотреть из-за тик токов."
            },
            {
                title: "Chained Soldier Season 2",
                ruTitle: "Раб спецотряда демонического города 2",
                review: "2-ой сезон держит планку. 9-ая серия удивила, были такие чувства как от 85-ой серии Хантера. Короч, там есть типо одна из 8 богинь, которая смогла одалеть и поглоьтьб капитана 8-го корпуса, а спустя 2 серии все вернулись. Надо было дожимать, такая сильаня сцена зря потрачена. Мне интересно что будет дальше. Кто бы мог подумать, да?) Так что жду 3-ий сезон."
            },
            {
                title: "100 Meters",
                ruTitle: "Стометровка",
                review: "Неплохое аниме с интересной рисовкой. Я бы хотел сказать, что оно меня смотивировало, но увы это не так)"
            },
            {
                title: "Nisemonogatari",
                ruTitle: "Истории подделок",
                review: "Уже не такое интересное, как предыдущие сезнон и фильмы, с натяжкой норм. Прикольно видеть что старшая сестра, которая младще гг становится выше (и по новелле будет намного выше гг), из-за того что гг полувампир и ростёт медленно. Этому удиляется много внимания, из-за чего появилось много несмешных шуток."
            },
            {
                title: "Dororo",
                ruTitle: "Дороро",
                review: "Дефолт. Больше нечего сказать. Абсолютно обычное аниме. Местами интересное, местами полная скукотища. Короче, очередной оверхайп."
            },
            {
                title: "Yasei no Last Boss ga Arawareta!",
                ruTitle: "Шальной последний босс явился!",
                review: "На удевеление неплохо и местами очень красиво."
            },
            {
                title: "Fate/Grand Order: Final Singularity - Grand Temple of Time: Solomon",
                ruTitle: "Судьба/Великий приказ: Финальная сингулярность — Соломон",
                review: "Как я понял, что порядок был непрвильынм? Да потому что в этом фильме появились все те герои, которые фигурировали в предыдущих фильмах и сезонах, а половину я не знал, если небольшне. Короче, если хотите ознакомится с этой вселнной, то вот - https://shikimori.io/articles/74-poryadok-prosmotra-fate-i-nasuverse-anime-v-sootvetstvii-s-pervoistochnikom А еще я понял минус трилогии фильмов 'Вельки Приказ', помимо того, что хер пойми в каком порядке смотреть, так большинство фильм постоенные на драках. С одной стороны постоянный экшон, но сдругой стороны, мне это уже поднадоело, нехватает чего-то просто, повседневного. Из-за чего этот фильм ниже всех остальных в тире."
            },
        ],
        'D': [
            {
            ...
            },
            {
                ...
                ruTitle: "Дни Мидори",
                review: "Кринж, но милый."
            },
            {
                title: "Hitsugi no Chaika 2",
                ruTitle: "Чайка - принцесса с гробом 2",
                review: "2-ой сезон послабее 1-го, не такой интересный, но всё равно прикольный. Концовка мне понравилась."
            },
            {
                title: "From Overshadowed to Overpowered: Second Reincarnation of a Talentless Sage",
                ruTitle: "Необыкновенный неудачник — Дневник переродившегося колдуна S-ранга",
                review: "Дефолт аниме, где гг переродился в своём же мире спустя 400 лет со своими силами."
            },
            {
                title: "Gaikotsu Kishi-sama, Tadaima Isekai e Odekakechuu II",
                ruTitle: "Рыцарь-скелет в ином мире 2",
                review: "Скучное аниме про имба гг."
            },
            {
                title: "Iron Wok Jan",
                ruTitle: "Железный котелок Жана!",
                review: "Повар-боец Сома получше будет."
            },
            {
                title: "From Old Country Bumpkin to Master Swordsman Season 2",
                ruTitle: "Старик из деревни становится Святым мечом 2",
                review: "2-ой сезон как-будто поскучнее будет, чем 1-ый."
            },
            {
                title: "Otome Game Sekai wa Mob ni Kibishii Sekai desu 2nd Season",
                ruTitle: "Мир отомэ-игр — это тяжёлый мир для мобов 2",
                review: "Рисовка поменялась, сюжет стал скучнее, но всё ещё можно смотреть."
            },
            {
                title: "Nige Jouzu no Wakagimi 2nd Season",
                ruTitle: "Юный лорд — мастер побега 2",
                review: "1-ый сезон и так был детским, но 2-ой как будто стал ещё более детским, а и с рисовкой что-то не так, либо мне кажеься. Ну типо смотрибельно, но... чёт не прям кайф."
            },
            {
                title: "Gleipnir",
                ruTitle: "Глейпнир",
                review: "На самом деле интересное аниме, но из-за нытика гг тяжело смотреть. У перосонажей должен быть баланс, а тут гг плачет, а тянка машина для убийств + сезон оборван на полуслове. Так ещё и бездарный фансервис. Но рисовка хорошая. Манга короткая, но как я и сказал интересная. Советую прочитать после аниме. Хочу раскрыть название. В манге есть супер-пупер тян, которая жесть какая сильная, а гг решил стать сосудом, который типо её запетал бы, но из-за того что она любит его, то стёрла ему память, а потом пошло поехало. Отсюда отсылка к скандинавскому мифу о неразрываемой цепи Глейпнир, сковавшей волка Фенрира. Финал как обычно счастливый. Типо гг поглащает духов, а тянка, которая ему всё время помогала остаётся одна. Но потом, оказывается, что гг жив, она находит его и хеппи энд."
            },
            {
                title: "Dorohedoro",
                ruTitle: "Дорохедоро",
                review: "Ничего не понял."
            },
            {
                title: "Cowboy Bebop",
                ruTitle: "Ковбой Бибоп",
                review: "Скучный оверхайп. Истории персонажей были интересными, но им посвящено малой серий, очень."
            },
            {
                title: "Cowboy Bebop: Knockin' on Heaven's Door",
                ruTitle: "Ковбой Бибоп: Достучаться до небес",
                review: "Такой себе фильм. У него есть хороший дубляж от реанимедии и хорошоая музыкА, кстати в сериале тоже музыка была не плохой."
            },
            {
                title: "Lord El-Melloi II Sei no Jikenbo: Rail Zeppelin Grace Note - Hakamori to Neko to Majutsushi",
                ruTitle: "Досье лорда Эль-Меллоя II: Могильщица, кошка и маг",
                review: "Эммм... нууу... я не знаю что сказать."
            },
            {
                title: "Marulk-chan no Nichijou",
                ruTitle: "Повседневная жизнь Марулк",
                review: "Оно просто есть."
            },
            {
                title: "Fate/Grand Order: First Order",
                ruTitle: "Судьба/Великий приказ: Первая Миссия",
                review: "Да, я начало истории посмотрел в самом конце и что? Ну а по поводу фильма, то он скучный."
            },
            {
                title: "Fate/strange Fake: Whispers of Dawn",
                ruTitle: "Судьба/Странная подделка: Шёпот рассвета",
                review: "Есть персонажи из предыдущих фильмов, рисовка хорошая, а всё остальное... ну не знаю, мне было скучно."
            },
        ],
        'E': [
            {
            ...
            },
            {
                ...
                review: "Я прочитал мангу, так что аниме для меня стало не таким интересным. Но есть минусы. Как всегда, супер сильных персонажей - магов Венде, показывают тупоголовыми, высокомерными болванчиками, которым просто повезло родится способными. И сейчас я говорю про всех без исключения. Ну и гг тоже умом не блещет. у него есть огромный потенциал, но он продолжает цепляться за желание быть магом. Кто-то скажет, что он хочет увидеть подругу. Но на кой хрен нужна такая подруга, которая выбрала башню, вместо Уилла? По итогу Элфи терпит, гг терпит, а ты оправдываешь. Кукичи - целевая этого аниме, которые ставят 9 баллов. Эх... мне никогда не понять таких персонажей, а особенно людей, которым такое нравится. Я продолжу смотреть аниме, возможно даже 3ий сезон гляну и мангу прочитаю, но не уверен что осилю досмотреть это сценарынй берд до конца. Со мной ещё челик спорил, приводя Жанну Д'Арк, как аргумент. Типо с ней тоже плохо поступили. Кто знает историю данной личности, понимает на сколько это тупо."
            },
            {
                title: "Tongari Boushi no Atelier",
                ruTitle: "Ателье колдовских колпаков",
                review: "Мангу колпаков ставят в один ряд с Фрирен. Не понимаю почему. Это аниме милое, красивое, но не более. Может сюжет какой-то... многослойный? Просто пока я вижу, как 4 девочки бегают и играются с магией, и  побеждают дракона облаками, а тип, который похож на Сатору, что-то разгадывает. Пока ничего не заставляет меня прочитать мангу? И финал так вообще позорный."
            },
            {
                title: "Boku no Hero Academia: I am a hero too 2026",
                ruTitle: "Моя геройская академия: Я тоже герой",
                review: "Просто ONA. Это не плохо, это просто никак."
            },
        ],
        'F': [
            // {

    ...
    '2026': {
        ...
        'A': [
            ...
            },
            {
                ...
                ruTitle: "Кланнад 2",
                review: "Скажу сразу, что это аниме было сделано по игре, а в игре несколько концовок, что и обыграли в аниме. Такое мне не особо нравится, но ничего не поделаешь. Жалко что я узнал про это произведение только сейчас, и не играл в оригинал. Увы, но я не уситчевый в плане новеллы, особенно таких старых. Как же жалко!(((((( Теперь про аниме. Я понял почему это аниме считается одним из драматичных. После 1-го сезона, в котором была забавная школьная жизнь с элементами драмы, 2-ой сезон порадает своей суровой атмосферой и реальностью. Мне было тяжело смотреть..."
            },
        ],
        'B': [
            {
        ...
        'C': [
            ...
            },
            {
                ...
                review: "Как альтернативная история неплохо. Минус в том, что проблема высосана из пальца. Типо у главы студ совета нет времени на парня-гг. А гг потом её отшивает и говорит, что обуза для неё. Хотелось бы увидеть побольше. Рисовка очень хорошая. Последняя 1-го сезона это есть эта ОВА."
            },
            {

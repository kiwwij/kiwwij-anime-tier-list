const droppedData = [
    ...
    },
    {
        ...
        "review": "Дропнул на 1-й серии из 51. Хоть это продолжение бригады пожарных, но оно ну уж прям детское и кринжовое, а также финал не как в манге, так что скип. Возможно этому аниме надо было больше времени чтобы раскрыться, но уже не пофиг, кстати рисовка очень даже ничего."
    },
    {

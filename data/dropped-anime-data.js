const droppedData = [
    ...
    },
    {
        ...
        "review": "Дропнул на 0-й серии из 1. Посмотрел 30 минут, ничего не понял, стало скучно."
    },
    {
        "title": "테러맨",
        "ruTitle": "Террорист",
    ...
    },
    {
        "title": "Jormungand",
        "ruTitle": "Ёрмунганд",
        "review": "Дропнул на n-й серии из 12. Пока не знаю, в это аниме явно что-то есть, но боевики не моё. Милые персонажи, но отсутствие логики немного портит картину, скучновато."
    }
]
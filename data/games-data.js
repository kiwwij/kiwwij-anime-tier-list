    ...
    tierListData['Игры'] = {
        ...
        data: {
            ...
            'A': [
                ...
                {
                    title: "Valorant",
                    review: "Не моя игра, ну не получается у меня в ней играть.",
                },
                {
                    title: "Marvel Rivals",
            ...
            'C': [
                ...
                },
                {
                    ...
                    review: "Я ожидал большего + это уже не канон, так что такое себе.",
                    img: "games/The_Prophecy_of_the_Throne.jpg",
                },
                {
                ...
                },
                {
                    ...
                    review: "Эммм... нууу.... японские ВНки нулевых что-то с чем-то.",
                    img: "games/sayanouta.jpg",
                },
                {
            ...
            'D': [
                ...
                {
                    title: "Evil School",
                    review: "Корейская ВНка с русской нейронной озвучкой. Я играл в демо, хоть и дропнул, но могу сказать, что в этом что-то есть. Не мой формат, да и сюжет не супер, но как опыт прикольно.",
                    img: "games/Evil_School.jpg",
                },
                {
                    title: "Sally Face",
                    review: "Смотреть видосы интереснее, чем играть самому.",
            ...
            'F': [
                ...
                },
                {
                    ...
                    review: "Интересная игра с отвратительной реализацией. Настолько неудобное управление с геймпада надо ещё поискать. Начало историй, не учитывая историю Коннара, начинается как унылое дерьмо сравнимое с мафией. В мафии ты работаешь сранным таксистом на неупраляемой машине, а в детроит ты служишь обрыгану и старому деду. Если перетерпеть, то становится интереснее, но не на долко. Спустя час ничанается нудятина. Медленно идёшь туда, как оказывается тебе не туда, идёшь в другое место и так раз 5. Повторюсь, мне было интересно узнать историю, но максимально нудно выполнять скучнейшие квесты.",
                },
                {
                ...
                },
                {
                    ...
                    review: "Если научится и понять как играть, то игра будет интересной и возможно будет приносить удовольствие. Но если не научится, то будет скучно и не интересно.",
                    img: "games/League_of_Legends.jpg",
                },
                {

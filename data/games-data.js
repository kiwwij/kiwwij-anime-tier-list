        ...
        data: {
            ...
            'B': [
                ...
                },
                {
                    ...
                    review: "Прикольная, красивая и оптимизированная игра. Единственная проблема - это скучный сюжет, в котором нет возможно скипать кат-сцены, а они занимают ну оч много времени. Основная квестовая линия, то есть сам сюжет игры, очень короткая. Я не проходил доп квесты, т.к. сама игра не заинтересовала. Но  картинка... моё почтение.",
                },
            ],
            'C': [
                { 
